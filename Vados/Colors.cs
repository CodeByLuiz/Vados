...
namespace Vados
{
    ...
    {
        public static Color bluePrimary = Color.FromArgb(48, 61, 99);
        public static Color blueSecondary = Color.FromArgb(88, 99, 152);
        public static Color blueTernary = Color.FromArgb(0, 0, 0);

        public static Color blueHighlight = Color.FromArgb(31, 73, 179);
